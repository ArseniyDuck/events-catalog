...
const Arrow: React.FC<PropsType & WrappedIconType> = ({ styles, color, direction }) => {
   let rotateDegree;
   switch (direction) {
      case 'top':
         rotateDegree = 180;
